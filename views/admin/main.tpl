...
<div class="navbar navbar-default" role="navigation">
      <div class="navbar-header"> <a class="" href="index.html"><span class="navbar-brand"><span class="fa fa-paper-plane"></span> MorePHP TEAM Blog</span></a></div>
...
<div class="sidebar-nav">
      <ul>
    <li><a href="#" data-target=".dashboard-menu" class="nav-header" data-toggle="collapse"><i class="fa fa-fw fa-dashboard"></i>系统信息<i class="fa fa-collapse"></i></a></li>
    <li>
          <ul class="dashboard-menu nav nav-list collapse in">
        <li ><a href="user.html"><span class="fa fa-caret-right"></span> 博客首页</a></li>
        <li><a href="index.html"><span class="fa fa-caret-right"></span> 系统信息</a></li>
      </ul>
        </li>
    ...
    <li>
          <ul class="premium-menu nav nav-list collapse in">
            <li ><a href="premium-profile.html"><span class="fa fa-caret-right"></span> 发布文章</a></li>
        <li ><a href="premium-blog.html"><span class="fa fa-caret-right"></span> 文章列表</a></li>
        <li ><a href="premium-blog-item.html"><span class="fa fa-caret-right"></span> 标签管理</a></li>
      </ul>
        </li>
    ...
    <li>
        ...
        <li ><a href="sign-in.html"><span class="fa fa-caret-right"></span> 添加用户</a></li>
        <li ><a href="sign-up.html"><span class="fa fa-caret-right"></span> 用户列表</a></li>
      </ul>
        </li>
    <li><a href="faq.html" class="nav-header"><i class="fa fa-fw fa-comment"></i> 评论管理</a></li>
    ...
    <li><a href="#" data-target=".link-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-heart"></i> 友链管理<i class="fa fa-collapse"></i></a> </li>
      <li>
        ...
        <li ><a href="sign-in.html"><span class="fa fa-caret-right"></span> 添加友链</a></li>
        <li ><a href="sign-up.html"><span class="fa fa-caret-right"></span> 友链列表</a></li>
      </ul>
        </li>
    ...
    <li>
        ...
        <li ><a href="privacy-policy.html"><span class="fa fa-caret-right"></span> 系统设置</a></li>
      </ul>
        </li>
        
    <li><a href="help.html" class="nav-header"><i class="fa fa-fw fa-question-circle"></i> 系统帮助</a></li>
  </ul>
    </div>
<div class="content">
      <div class="header">
    ...
    <ul class="breadcrumb">
          <li><a href="index.html">后台界面</a> </li>
